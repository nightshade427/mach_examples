...
# Starts development server on port 3000 (can be configured)
# Starts telemetry server on port 3001 (can be configured) to see perfomance and detailed errors, uses signoz
# open editor/ide
# write code
# save file
