  ...
  return (config) {
    .resources = {
      ...
      {"todos", "/todos",
        .get = {
          query(
            {.set_key = "todos", .db = "todos_db", .query =
              "SELECT id, title, done, created_at "
              "FROM todos ORDER BY created_at DESC;"
            },
            {.set_key = "stats", .db = "todos_db", .query =
          ...
          render(
            ...
            "<div class='max-w-lg mx-auto'>"
              ...
              "{{/todos}}"
              "<a href='{{url:activity}}' class='inline-block mt-6 text-sm text-blue-600 underline'>"
      ...
      {"activity", "/activity",
        .get = {
          query({.set_key = "logs", .db = "todos_db", .query =
      ...
      {m_bad_request, {
        render(
          ...
          "<div class='max-w-lg mx-auto'>"
            ...
            "<a href='{{url:todos}}' class='text-blue-600 underline'>&#8592; Back</a>"
          "</div>"
          "</body>"
          "</html>"
        )
